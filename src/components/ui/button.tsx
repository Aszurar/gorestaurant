  ...
  "inline-flex items-center font-semibold hover:cursor-pointer justify-center gap-2 whitespace-nowrap rounded-lg text-sm transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 focus-visible:ring-4 focus-visible:outline-1 aria-invalid:focus-visible:ring-0",
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input bg-background shadow-xs hover:bg-accent hover:text-accent-foreground active:bg-accent/90',
        secondary:
        ...
        success:
          'bg-success text-success-foreground hover:brightness-110 active:brightness-100 shadow-xs',
        blank:
          'bg-white dark:bg-black text-background-foreground shadow-md hover:bg-background/50 active:bg-background',
      },
      size: {
